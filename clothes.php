...
<head>
  ...
  <link rel="stylesheet" href="Custom/clothes.css">
...
<body>
  ...
  <div class="div-img">
    ...
    <div class="img-container">
      <img src="image/clothes.jpeg" alt="*" class="img-banner">
      <!-- ข้อความด้านบนซ้าย -->
      <div class="top-left-text scale-up-hor-left ">
        <p style="background-color: black;">หมวด เสื้อผ้า</p>
      </div>
    </div>
