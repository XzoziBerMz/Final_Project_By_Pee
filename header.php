...
<body>
    <!-- Navbar5 -->
    <nav class="navbar navbar-expand-lg navbar-dark container-fluid" style=" background-color: #2C3539; height:fit-content;   box-shadow: 0 4px 7px 0 rgba(0, 0, 0, 0.40), 0 6px 19px 0 rgba(0, 0, 0, 0.20); z-index: 1;">

  <div class=" navbar-collapse " >

    <a href="index.php" style="margin-left: 3%;"><i class="fa-solid fa-house" style="color: #d9d9d9 ; margin-top: 16px;"><p style="float: right; opacity: 0.3;">&nbsp; &nbsp; &nbsp;|</p></i></a>
  ...
  <?php foreach($result as $row) { ?>
    <li class="dropdown">
          <a href="electronic_quipment.php?act=showbytype&type_id=<?php echo $row['type_id'];?>"> <?php echo $row ["type_name"]; ?></a>
          <div class="dropdown-content">
          <?php
  ...
  <?php foreach($result as $row) { ?>
    <li class="dropdown">
          <a href="clothes.php?act=showbytype&type_id=<?php echo $row['type_id'];?>"> <?php echo $row ["type_name"]; ?></a>
          <div class="dropdown-content">
          <?php
  ...
  <?php foreach($result as $row) { ?>
    <li class="dropdown">
          <a href="vehicle.php?act=showbytype&type_id=<?php echo $row['type_id'];?>"> <?php echo $row ["type_name"]; ?></a>
          <div class="dropdown-content">
          <?php
  ...
  <!-- ปุ่มย่อจอ -->      
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation" style=" margin-top: 5px; float: right; margin-bottom: 10px;"> <span class="navbar-toggler-icon"></span> </button>
