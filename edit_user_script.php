...
if (isset($_POST['user_id']) && isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['email'])) {
  ...
  // ตรวจสอบว่ามี current_password หรือไม่
  if ($current_password) {
  ...
  if ($stmt->execute()) {
    // ตรวจสอบว่ามีการกำหนดรหัสผ่านใหม่และ current_password ถูกต้อง
    if ($current_password && isset($_POST['new_password']) && !empty($_POST['new_password'])) {
