  ...
  <table class="table table-striped">
    ...
    ?>
       <tr>
        ...
        <td><a class="btn btn-primary openPopup" data-href="./adminView/viewEachOrder.php?orderID=<?=$row['order_id']?>" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#viewModal">View</a></td>
        </tr>
    <?php
