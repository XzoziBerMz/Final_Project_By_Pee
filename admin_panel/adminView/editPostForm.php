<div class="container p-2" style="margin-left: 10%;">
  ...
  <form id="update-Items" onsubmit="return updatePost()" enctype="multipart/form-data">
    ...
    <div class="form-group" style="margin-bottom: 20px;">
      ...
      <input type="number" class="input-price" id="fixedPrice" name="fixedPrice" value="<?=$row1['product_price']?>" style="display: <?=$row1['product_price'] != 'ฟรี' && $row1['product_price'] != 'ต่อรองได้' ? 'inline-block' : 'none'?>">
      <input type="number" class="input-price" id="negotiablePrice" name="negotiablePrice" style="display: <?=$row1['product_price'] == 'ต่อรองได้' ? 'inline-block' : 'none'?>" value="<?=$row1['product_price'] == 'ต่อรองได้' ? $row1['product_price'] : ''?>">
      <input type="text" class="input-price" id="freePrice" name="freePrice" style="display: <?=$row1['product_price'] == 'ฟรี' ? 'inline-block' : 'none'?>" value="ฟรี" disabled>
    ...
    <div class="form-group">
      <button type="submit" style="height:40px; background-color: #009933; color: white;" class="btn">Update Item</button>
    </div>
  </form>
  <?php
      }
