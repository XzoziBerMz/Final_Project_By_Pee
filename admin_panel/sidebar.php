...
<div class="side-header">
    ...
    <h5 style="margin-top:10px;">Hello : <span style="color: #00CC33;"><?php echo $admin ['firstname'] ?></span></h5>
</div>
...
<hr style="border:1px solid; background-color:#00CC33; border-color:white;">
    ...
    <a href="#SubCategory"   onclick="showSubCategory()" ><i class="fa fa-th-list"></i> Sub Category</a>    
