...
<div class="new_container m-auto mt-5" style="margin-top: 30px;">
    <h3 class="mt-4"><p class="focus-in-expand">REGISTER</p></h3>
    <hr>
...
<?php if(isset($_SESSION['warning'])) { ?>
  ...
  <div class="mb-4">
    ...
    <div class="mb-4">
    <input type="text" class="form-control" name="confirm_password"placeholder="ยืนยันรหัสผ่าน">
</div>
...
<hr>
<p class="text-start" style="margin-bottom: 3px">เป็นสมาชิกใช่ไหม คลิ้กที่นี่เพื่อ <a href="signin.php"> เข้าสู่ระบบ</a></p>
</div>
