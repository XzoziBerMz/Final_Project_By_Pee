...
if (isset($_SESSION['user_login']) || isset($_SESSION['admin_login'])) {
    ...
    // คิวรีเพื่อดึงโพสท์ที่ user_id หรือ admin_login ตรงกับผู้ใช้งานปัจจุบัน
    ...
    // ใช้ตัวแปรที่ถูกต้องตามเงื่อนไขที่กำหนด
    if (isset($user_id)) {
        $stmt->bindParam(':user_id', $user_id, PDO::PARAM_INT);
    } elseif (isset($admin_login)) {
        $stmt->bindParam(':user_id', $admin_login, PDO::PARAM_INT);
    }
